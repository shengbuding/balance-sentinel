...
fun WalletNavHost(
    ...
    Scaffold(
        ...
        NavHost(
            ...
            composable(AppRoute.BackupRestore.route) { BackupRestoreRouteScreen(dataManagementViewModel) { navController.popBackStack() } }
            composable(AppRoute.AlertSettings.route) { AlertSettingsScreen { navController.popBackStack() } }
